...
<body ng-app="monthlyApp" ng-controller="categoryController">
    ...
    <?php include_once("menuheader.php");?>
			<div id="page-wrapper">
							...
							<div id="row">
											<div class="col-lg-12">
													<h1 class="page-header"><?php echo 'Expence Category';?></h1>
											</div>
											<!-- /.col-lg-12 -->
									</div>
                  ...
                  <div class="panel panel-primary">
										<div class="panel-heading">
												<i class="fa fa-bar-chart-o fa-fw"></i> <?php echo 'List Category'; ?> 
										</div>
...
<script type="text/javascript" src="js/angular_controller/category_controller.js"></script> 
