...
<body ng-app="monthlyApp" ng-controller="accountController">
    ...
    <?php include_once("menuheader.php");?>
			<div id="page-wrapper">
							...
							<!-- /.row -->
							<a href="#new" class="btn white btn-primary float-right" data-toggle="modal"><i class="fa fa-plus"></i> Add New Account Type</a>
							
							<div class="row">
								<div class="col-lg-12">
                  <div class="panel panel-primary">
										<div class="panel-heading">
												<i class="fa fa-bar-chart-o fa-fw"></i> <?php echo 'List Account'; ?> 
										</div>
                      ...
                      <div class="">
                        <table class="table table-striped table-bordered table-hover" id="assetsdata">
                          <thead>
													...
													<tbody>
														<tr ng-repeat="(key, value) in aclist">
															<td>{{value.AccountName}}</td>
															
															<td colspan="2" class="notification">
																<a href="#EditCat" class="" data-toggle="modal" ng-click="deletemodel(value.AccountId,value.AccountName)"><span class="btn btn-primary btn-xs fa fa-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="Edit"></span></a>
																<a href="#DeleteCat"  data-toggle="modal" ng-click="deletemodel(value.AccountId)"><span class=" fa fa-trash btn btn-primary btn-xs" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php //echo $DeleteCategories; ?>"></span></a>			
															</td>
														</tr>
													</tbody>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
									...
									<div class="modal-body">
											Are you sure to delete the account type.
									</div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
								<h4 class="modal-title" id="myModalLabel"><?php echo 'Edit Account'; ?></h4>
							</div>
							<div class="modal-body">
								<div class="form-group">
									<label for="category"><?php echo 'Account Name'; ?></label>
        ...
        <!-- /#page-wrapper -->
            ...
            <div class="modal-content">
              <div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									<h4 class="modal-title" id="myModalLabel"><?php echo 'Add New Account type'; ?></h4>
								<div class="alert alert-danger" ng-if="error">
	                                Please re-check form .
	                            </div>
							</div>
							<div class="modal-body">
											<div class="form-group">
													<label for="category"><?php echo 'Account Name'; ?></label>
													<input class="form-control" required placeholder="<?php echo 'Account Name'; ?>" ng-model="category" type="text" autofocus>
											</div>
							</div>
							<div class="modal-footer">
...
<script type="text/javascript" src="js/angular_controller/account_controller.js"></script> 
