...
(function(window, document, undefined) {
    ...
    .provider('$affix', function() {
        ...
        this.$get = ["$window", "debounce", "dimensions",
    ...
    .directive('bsAffix', ["$affix", "$window",
    ...
    .directive('bsAlert', ["$window", "$sce", "$alert",
    ...
    .directive('bsAside', ["$window", "$sce", "$aside",
    ...
    .directive('bsCheckbox', ["$button", "$$rAF",
        function($button, $$rAF) {
    ...
    .directive('bsCollapse', ["$window", "$animate", "$collapse",
    ...
    .directive('bsCollapseTarget', ["$animate",
        function($animate) {
    ...
    .provider('$datepicker', function() {
        ...
        var defaults = this.defaults = {
            ...
            startWeek: 0,
            daysOfWeekDisabled: '',
            iconLeft: 'sf sf-chevron-left',
            iconRight: 'sf sf-chevron-right'
        };

        this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "datepickerViews", "$tooltip",
    ...
    .directive('bsDatepicker', ["$window", "$parse", "$q", "$locale", "dateFilter", "$datepicker", "$dateParser", "$timeout",
    ...
    .provider('datepickerViews', function() {
        ...
        this.$get = ["$locale", "$sce", "dateFilter",
    ...
    .provider('$dropdown', function() {
        ...
        this.$get = ["$window", "$rootScope", "$tooltip",
    ...
    .directive('bsDropdown', ["$window", "$sce", "$dropdown",
    ...
    .provider('$dateParser', ["$localeProvider",
    ...
    .factory('dimensions', ["$document", "$window",
    ...
    .directive('bsModal', ["$window", "$sce", "$modal",
    ...
    .directive('bsNavbar', ["$window", "$location", "$navbar",
    ...
    .directive('bsPopover', ["$window", "$sce", "$popover",
    ...
    .provider('$scrollspy', function() {
        ...
        this.$get = ["$window", "$document", "$rootScope", "dimensions", "debounce", "throttle",
    ...
    .directive('bsScrollspy', ["$rootScope", "debounce", "dimensions", "$scrollspy",
    ...
    .directive('bsScrollspyList', ["$rootScope", "debounce", "dimensions", "$scrollspy",
        function($rootScope, debounce, dimensions, $scrollspy) {
    ...
    .provider('$select', function() {
        ...
        this.$get = ["$window", "$document", "$rootScope", "$tooltip",
    ...
    .directive('bsSelect', ["$window", "$parse", "$q", "$select", "$parseOptions",
    ...
    .directive('bsTabs', ["$window", "$animate", "$tab",
    ...
    .directive('bsPane', ["$window", "$animate", "$sce",
    ...
    .provider('$timepicker', function() {
        ...
        var defaults = this.defaults = {
            ...
            hourStep: 1,
            minuteStep: 5,
            iconUp: 'sf sf-chevron-up',
            iconDown: 'sf sf-chevron-down',
            arrowBehavior: 'pager'
        };

        this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "$tooltip",
    ...
    .directive('bsTimepicker', ["$window", "$parse", "$q", "$locale", "dateFilter", "$timepicker", "$dateParser", "$timeout",
    ...
    .provider('$tooltip', function() {
        ...
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "dimensions", "$$rAF",
    ...
    .directive('bsTooltip', ["$window", "$location", "$sce", "$tooltip", "$$rAF",
    ...
    .directive('bsTypeahead', ["$window", "$parse", "$q", "$typeahead", "$parseOptions",
