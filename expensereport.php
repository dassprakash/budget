			...
			<div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                       <i class="glyphicon glyphicon-stats"></i> <?php echo 'History of Expense';?>
                            ...
                            <table class="table table-bordered table-hover table-striped" id="assetsdata">
        	                	...
        	                	<tbody>        							 
        							...
        							<td colspan="2" class="notification">
        								<a href="#EditIncome" class="" data-toggle="modal" ng-click="editmodel(value.Title,value.Amount,value.CategoryId,value.AccountId,value.Dates,value.Description,value.AccountName,value.BillsId)"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo 'Edit Income';?>"></span></a>
...
<script type="text/javascript" src="js/angular_controller/expence_controller.js"></script> 
