...
(function(window, document, undefined) {
    ...
    // Source: aside.tpl.js
    angular.module('mgcrea.ngStrap.aside').run(['$templateCache',
    ...
    // Source: alert.tpl.js
    angular.module('mgcrea.ngStrap.alert').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.datepicker').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.dropdown').run(['$templateCache',
        function($templateCache) {
    ...
    // Source: modal.tpl.js
    angular.module('mgcrea.ngStrap.modal').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.popover').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.select').run(['$templateCache',
        function($templateCache) {
    ...
    // Source: tab.tpl.js
    angular.module('mgcrea.ngStrap.tab').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.timepicker').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.tooltip').run(['$templateCache',
        function($templateCache) {
    ...
    angular.module('mgcrea.ngStrap.typeahead').run(['$templateCache',
        function($templateCache) {
